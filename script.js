      ...
      <section class="screen screen-landing">
        ...
        <div class="landing-content">
          <div class="landing-intro">
            ...
            <div class="brand-mark" aria-label="The Drama"><span>E</span><i></i><span>C</span></div>
    ...
    return `
      <section class="screen screen-result">
        ...
        <article class="profile-card" style="--profile-accent:${character.accent}">
          ...
          <div class="profile-symbol" aria-hidden="true">${escapeHtml(character.name.slice(0, 1))}</div>
